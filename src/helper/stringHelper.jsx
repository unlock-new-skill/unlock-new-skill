...
export const compareJSONObjects = (jsonStr, jsonObj) => {
...
export const getEnv = () => {
	...
	if (url.startsWith('https://printexpress-fe-dev.vercel.app/')) {
		return 'dev'
	}
	if (url.startsWith('https://rapidprinttee.com')) {
		return 'prod'
	}
}
...
export function isValidTrackingCode(str) {
	return /^[\d\s]+$/.test(str)
}
